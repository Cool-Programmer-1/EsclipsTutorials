...
/* Hi, I am Shamshad Alam and you are watching my "Smart Health Care System" Project in Java / */
...

{
    public static void main(String args[])
    {
        ...
        System.out.println("\n--------------------------------------------------------------------------------");
        System.out.println("      *** Welcome to Health Care Management System Project in Java ***");
        System.out.println("--------------------------------------------------------------------------------");
